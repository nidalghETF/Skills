/**
 * Tests for Edge AI Gateway Configurator
 */

const skill = require('../index.js');

describe('edge-ai-gateway', () => {
  ...
  test('should execute successfully with valid inputs', async () => {
    const params = {
      gateway_model: "test-value",
      inference_model: "test-value"
    };
  ...
  test('should sanitize inputs (Category 8)', async () => {
    const params = {
      gateway_model: "test<script>alert(1)</script>"
    };
