/**
 * Tests for Version Diff Analyzer
 */

const skill = require('../index.js');

describe('version-diff-analyzer', () => {
  ...
  test('should execute successfully with valid inputs', async () => {
    const params = {
      current_version: "test-value",
      target_version: "test-value"
    };
  ...
  test('should sanitize inputs (Category 8)', async () => {
    const params = {
      current_version: "test<script>alert(1)</script>"
    };
